...
def dummy():
    ...
    fltName = st.multiselect('Select the Fleet', options=vsl_list_fleetwise.keys(), default=list(vsl_list_fleetwise.keys())[0])
    ...
    df_active_ships_currDRS[["delay_hr", "downtime_hr"]] = df_active_ships_currDRS[["delay_hr", "downtime_hr"]].astype(float)
    df_active_ships_currDRS[["delay_hr", "downtime_hr"]] = df_active_ships_currDRS[["delay_hr", "downtime_hr"]].fillna(0)
    ...
    df1 = df_active_ships_currDRS[
        ['vslCode', 'dt_ocurred', "delay_hr", "downtime_hr", 'critical_eq_tf', "blackout_tf", "docking_tf",
         "dispensation_tf", "coc_tf", 'vslFleet']]
    # df1=df1[mask_dt]
    df2 = df_active_ships_currDRS[['dt_ocurred', 'vslCode', 'rpt_by']]
    df3 = df_active_ships_currDRS[['vslCode', 'status', 'Overdue_status', 'DRS_ID', 'vslFleet']]
